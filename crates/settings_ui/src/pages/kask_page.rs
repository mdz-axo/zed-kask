...
//! - MCP Servers (built-in servers + load toggles + `load_default` master toggle)
                    ...
                    move |settings, _| {
                        ...
                        match (struct_name, field_name) {
                            ...
                            ("research", "research_db") => {
                                kask.research.get_or_insert_default().research_db =
                                    Some(parsed.clone());
                            }
                            ...
                            ("models", "qa_verification_model") => {
                                kask.models.get_or_insert_default().qa_verification_model =
                                    Some(parsed.clone());
                            }
                            ("models", "ocr_model") => {
