...
const URL_REGEX: &str = r#"(ipfs:|ipns:|magnet:|mailto:|gemini://|gopher://|https://|http://|news:|file://|git://|ssh:|ftp://|zed-kask://|zed://)[^\u{0000}-\u{001F}\u{007F}-\u{009F}<>"\s{-}\^⟨⟩`']+"#;
...
mod tests {
    ...
    fn test_url_regex() {
        ...
        re_test(
            URL_REGEX,
            "open zed-kask://settings/theme and zed://channel/the-channel now",
            vec!["zed-kask://settings/theme", "zed://channel/the-channel"],
        );
    }
