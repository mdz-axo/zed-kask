...
- [ ] **I - ontology-bounded affordances** - DEFERRED (per .rules, do not build the catalog trait until a 2nd ontology domain materializes; FIBO tags already on portfolio tiles).