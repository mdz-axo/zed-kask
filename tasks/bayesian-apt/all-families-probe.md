...
### After C0.5 (bracket + single-cohort fallback)

| Family                   | Venue      | Records | Eligible | Indices | Published tenors                 |
| ------------------------ | ---------- | ------- | -------- | ------- | -------------------------------- |
| policy_interest_rate     | Kalshi     | 790     | 388      | 6       | 1m, 2m, 3m, 6m                   |
| policy_interest_rate     | Polymarket | 76      | 29       | 2       | 6m                               |
| consumer_price_inflation | Kalshi     | 703     | 514      | 6       | 1m, 2m, 3m                       |
| consumer_price_inflation | Polymarket | 92      | 92       | 2       | 6m                               |
| crude_oil_price          | Kalshi     | 388     | 123      | 6       | 1m, 3m, 6m                       |
| crude_oil_price          | Polymarket | 12      | 0        | 0       | no eligible contracts            |
| natural_gas_price        | Kalshi     | 319     | 191      | 5       | 1m, 3m, 6m                       |
| natural_gas_price        | Polymarket | 2       | 0        | 0       | no eligible contracts            |
| bitcoin_price            | Kalshi     | 714     | 37       | 5       | 1m, 6m                           |
| bitcoin_price            | Polymarket | 112     | 48       | 1       | 6m                               |
| ethereum_price           | Kalshi     | 826     | 26       | 6       | 1m, 6m                           |
| ethereum_price           | Polymarket | 107     | 40       | 1       | 6m                               |
| real_gdp_growth          | —          | —       | —        | —       | no BaseEvent materiality setting |

**All 6 families publish on Kalshi** (multiple tenors each). **4 of 6 publish on
Polymarket** (6m only — the year-end contracts are within the 6m window's
cohort tolerance). 2 families (oil, natural gas) have no eligible Polymarket
contracts (nearly empty catalogs).

### Before C0.5 (bracket-only — for comparison)

| Family                   | Venue      | Indices | Published tenors |
| ------------------------ | ---------- | ------- | ---------------- |
| policy_interest_rate     | Kalshi     | 2       | 6m               |
| policy_interest_rate     | Polymarket | 0       | none             |
| consumer_price_inflation | Kalshi     | 2       | 3m               |
| consumer_price_inflation | Polymarket | 0       | none             |
| crude_oil_price          | Kalshi     | 1       | 1m               |
| natural_gas_price        | Kalshi     | 0       | none             |
| bitcoin_price            | Kalshi     | 0       | none             |
| ethereum_price           | Kalshi     | 0       | none             |

C0.5 increased published indices from 5 (across 3 family/venue combinations)
to 46 (across 10 family/venue combinations).
...
This means CP-CMP passes when the family has _any_ contracts in the window
