...
| `regulation`                 | `LedgerHealth`, `RegulationHealth`, `RegulationSpan`, `ToolSubsystem`                                                                                                                                         |
...
| `ports`                      | Hexagonal port traits: `InferencePort`, `ToolDispatchPort`, `WorktreeSpawnPort`, `MemoryPort`, plus their request/result/error types (`ChatMessage`, `InferenceError`, `MemoryError`, …)                                      |
...
| `agent_paths`                | Per-agent filesystem path helpers + data-dir resolution (`resolve_data_dir`, `resolve_under_data_dir`, `agent_dir`, `agent_db`, …)                                                                 |
