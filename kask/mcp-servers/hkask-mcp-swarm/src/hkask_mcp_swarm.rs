...
// `src/*.rs`. The single source of truth — the `tool_surface_is_exactly_54_registered_tools`
...
pub use crate::local_runtime::{
    GroundingSummary, LazyLocalSwarmRuntime, LocalDelegateResult, LocalSwarmRuntime,
...
mod tests {
    ...
    #[test]
    fn tool_surface_is_exactly_54_registered_tools() {
        ...
        assert_eq!(
            names, expected,
            "registered tool surface drifted from the documented 54"
        );
    }
}
