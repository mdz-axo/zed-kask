...
declare -A TASKS=(
    ...
    [local_critic]=$'Review this text against the criteria '\''mentions revenue'\'', '\''mentions growth'\'': The quarterly report shows revenue of $4.2M, up 12% year over year.\x1fcontains\x1frevenue\nReview this text against the criteria '\''names the service'\'', '\''states the status'\'': {"event": "deploy", "service": "api-gateway", "status": "healthy"}\x1fcontains\x1fapi-gateway\nReview this text against the criteria '\''mentions revenue'\'': The meeting notes mention no financial figures.\x1fnot_contains\x1finvented fact'
)
