...
- **No upstream edits outside D1–D23 seams.** If an upstream edit seems necessary, propose a new D-seam entry in `DIVERGENCE.md` (Task D1) instead of editing upstream directly.
