...
| `crates/kask_extensions_ui` | zed-kask-side skill marketplace UI (center-pane `Item`, sibling of `kask_panel`); documented in [`plans/kask-extensions-panel-and-skill-sharing.md`](../plans/kask-extensions-panel-and-skill-sharing.md) | [`plans/kask-extensions-panel-and-skill-sharing.md`](../plans/kask-extensions-panel-and-skill-sharing.md) |
