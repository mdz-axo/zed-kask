...
- [`kask/docs/architecture/zed-host-architecture-plan.md`](../architecture/zed-host-architecture-plan.md): D1–D28 integration seams (D21 = conversation-injector, D22 = block-reachability pins, D23 = worktree spawn wiring; D24–D28 added 2026-08-05 through 2026-08-12 — see `DIVERGENCE.md` for the authoritative seam list).
- [`DIVERGENCE.md`](../../../DIVERGENCE.md): the authoritative divergence surface (D1–D28).
