...
2. **The swarm MCP server** (`hkask-mcp-swarm`) — 53 tools (27 ABW + 26 local)
...
```mermaid
flowchart TD
    Panel[Swarm Panel<br/>crates/swarm_panel] -->|tool calls via shared_tool_invoker| Server[hkask-mcp-swarm<br/>53 tools]
...
| `combined_router` (53 tools) | `kask/mcp-servers/hkask-mcp-swarm/src/hkask_mcp_swarm.rs:132-140`       |
