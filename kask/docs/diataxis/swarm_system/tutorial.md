...
2. **The swarm MCP server** (`hkask-mcp-swarm`) — 41 tools (27 ABW + 14 local)
...
verified_against: crates/swarm_panel/src/swarm_panel.rs:230,289,1834,1870; kask/mcp-servers/hkask-mcp-swarm/src/hkask_mcp_swarm.rs:2822
status: VERIFIED
-->
...
all 41 tools are always registered.
...
41-tool surface, the active backend, and the `swarm-intelligence` skill.
...
- [Reference: The 41-Tool Surface](./reference.md) — every tool, grouped.
