...
2. **The swarm MCP server** (`hkask-mcp-swarm`) — 47 tools (27 ABW + 20 local)
...
verified_against: crates/swarm_panel/src/swarm_panel.rs:230,289,1834,1870; kask/mcp-servers/hkask-mcp-swarm/src/hkask_mcp_swarm.rs:3003
status: VERIFIED
-->
...
all 47 tools are always registered.
...
47-tool surface, the active backend, and the `swarm-intelligence` skill.
...
- [Reference: The 47-Tool Surface](./reference.md) — every tool, grouped.
