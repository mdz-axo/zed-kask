...
All 51 tools are always registered; `kask.swarm.mode` selects which substrate
...
`tool_surface_is_exactly_51_registered_tools` (`hkask_mcp_swarm.rs:350`) pins
the count at 51 so a future tool addition
