...
| [`reference/mcp-servers/README.md`](reference/mcp-servers/README.md) | MCP server registry — 10 built-in servers (child processes over stdio). |
...
| Document | Description |
|----------|-------------|
| [`qa/mcp-server-qa-strategy.md`](qa/mcp-server-qa-strategy.md) | Per-tool QA routine for all 195 tools across 10 MCP servers. |
