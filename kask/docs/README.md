...
| [`reference/skills/README.md`](reference/skills/README.md) | Registry of 68 skills (54 shipped to users, 14 developer-only), 61 template namespaces, and 300 `.j2` resources. |
