...
| **In-process MCP** (the 12 MCP servers wired into zed-kask) | The active per-user data directory | Capability tokens minted at composition-root wiring time | Per-user SQLCipher DB | User-attested HKDF keys |
