...
- The `expectations_gap` template filters USD capitalization and normalized 200-day traded value before one fundamentals request per provisional issuer. The highest-liquidity eligible line supplies the issuer analysis and price; the provider-reported primary ticker remains provenance. The authoritative driver model reconciles SG&A, D&A, and other operating expenses to reported operating income before solving growth and profitability. Missing reconciliation is unavailable, not zero. Company research remains downstream of the screen.
