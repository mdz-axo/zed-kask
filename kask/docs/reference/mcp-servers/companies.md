...
flowchart TD
    ...
    Comb --> R1["financial_data_router<br/>10 tools"]
    Comb --> R2["analysis_router<br/>6 tools"]
    Comb --> R3["valuation_router<br/>12 tools"]
    Comb --> R4["portfolio_router<br/>13 tools"]
    Comb --> R5["analytics_router<br/>6 tools"]
    Comb --> R6["economic_profit_router<br/>2 tools"]
    Comb --> R7["expectations_router<br/>2 tools"]
    Comb --> R8["transcript_router<br/>2 tools"]
