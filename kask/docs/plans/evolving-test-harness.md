...
non-degenerate: a better suite kills more mutants), `w_k = 0.5`,
and `Δcost_norm = Δcost_tokens / max_cost_tokens` (normalized so cost is
comparable to the [0,1] coverage/mutation-score axes). This norm is **honest**:
