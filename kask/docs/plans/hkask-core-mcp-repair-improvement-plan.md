...
1. Confirm desired host-worktree authority and spawned-thread restriction propagation; an explicitly authorized new task is different from ambient same-user access.
