...
**N1 — skill consolidation review (operator request 2026-09-24), after P6 and L1:** apply the deletion test across the skill corpus and bring a ranked merge proposal for operator decision; no merge without approval.
