...
8. Review-first: do not implement changes here — implementation is the separate, `fix_mode`-gated implement phase. Respond with `review`, `lessons_learned`, `next_review_focus`.
