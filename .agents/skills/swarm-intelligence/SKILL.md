...
| **C1** second-order monitor         | Reasoning-loop + sensor-truth-divergence detection over the iteration log; local delegation results do not carry reasoning steps. | review of observed iteration-log/Go See evidence; no registered second-order tool                                                                                                                                                                                                                                                                                          |
